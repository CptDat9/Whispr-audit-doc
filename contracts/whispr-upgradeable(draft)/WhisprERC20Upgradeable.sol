...
import "./WhisprECDSAUpgradeable.sol";
import "./WhisprEIP712Upgeadeable.sol";
import "./WhisprPrivacyPolicyUpgradeable.sol";

contract WhisprERC20Upgradeable is
    IERC20,
    AccessControlUpgradeable,
    WhisprECDSAUpgradeable,
    WhisprEIP712Upgradeable,
    WhisprPrivacyPolicyUpgradeable
{
    ...
    function _isAllowedByPrivacyPolicy(
        ...
        return
            ...
            hasAccess(
                owner,
                _msgSender(),
                WhisprPrivacyPolicyUpgradeable.PrivacyPolicy.Reveal
            );
    }
